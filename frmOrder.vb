...
Public Class frmOrder
    ...
    Private Sub frmOrder_FormClosing(ByVal sender As System.Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles MyBase.FormClosing
        Me.Hide()
        FrmMain.Show()
    End Sub
    ...
    Private Sub Save_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Save.Click
        ...
        Try
            ...
            Else
                ...
                Dim cb As String = "insert Into orderinfo(OrderNo,OrderDate,OrderStatus,CustomerNo,CustomerName,SubTotal) VALUES ('" & txtOrderNo.Text & "','" & dtpOrderDate.Text & "','Uncompleted','" & txtCustomerNo.Text & "','" & txtCustomerName.Text & "','" & CInt(txtSubTotal.Text) & "')"
