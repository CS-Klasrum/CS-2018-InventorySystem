...
Public Class frmSales
    ...
    Private Sub Save_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Save.Click
        ...
        Else
            ...
            Dim cb As String = "insert Into billinfo(InvoiceNo,BillingDate,CustomerNo,CustomerName,SubTotal,TaxPercentage,TaxAmount,GrandTotal,TotalPayment,PaymentDue) VALUES ('" & txtInvoiceNo.Text & "','" & dtpTransactionDate.Text & "','" & CInt(txtSubTotal.Text) & "','" & CDbl(txtTaxPer.Text) & "','" & CInt(txtTaxAmt.Text) & "','" & CInt(txtTotal.Text) & "','" & CInt(txtTotalPayment.Text) & "','" & CInt(txtPaymentDue.Text) & "')"
        ...
        Try
            ...
            For j = 0 To temp - 1
                If (ListView1.Items(j).SubItems(1).Text = txtProductCode.Text And ListView1.Items(j).SubItems(6).Text = Val(txtAvailablePackets.Text) / Val(txtAvailableCartons.Text)) Then
                    ...
                    ListView1.Items(j).SubItems(2).Text = txtProductCode.Text
                    ListView1.Items(j).SubItems(3).Text = txtProductName.Text
                    ListView1.Items(j).SubItems(4).Text = txtWeight.Text
    ...
    Private Sub txtQty_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtCartons.TextChanged
        ...
        Try
            ...
            txtTotalAmount.Text = CInt(Val(txtPackets.Text) * Val(txtWeight.Text))
        Catch ex As Exception
            MessageBox.Show(ex.Message, "Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
        End Try
    End Sub
    ...
    Private Sub btnRemoved_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnRemoved.Click
        Try
    ...
    Private Sub PrintDocument1_PrintPage(ByVal sender As System.Object, ByVal e As System.Drawing.Printing.PrintPageEventArgs) Handles PrintDocument1.PrintPage
        e.Graphics.DrawString("Welcome to JJJ Marketing", New Font("Arial", 20, FontStyle.Bold), Brushes.Black, New Point(260, 32))
        e.Graphics.DrawString("Date:" + DateTime.Now, New Font("Arial", 12, FontStyle.Bold), Brushes.Black, New Point(30, 60))


        e.Graphics.DrawString("----------------------------------------------------------------------------------------------------------------------", New Font("Monotype", 12, FontStyle.Bold), Brushes.Black, New Point(30, 80))



        e.Graphics.DrawString("ProductName", New Font("Arial", 10, FontStyle.Bold), Brushes.Black, New Point(20, 110))
        e.Graphics.DrawString("Quantity", New Font("Arial", 10, FontStyle.Bold), Brushes.Black, New Point(400, 110))
        e.Graphics.DrawString("Price", New Font("Arial", 10, FontStyle.Bold), Brushes.Black, New Point(700, 110))



        e.Graphics.DrawString("----------------------------------------------------------------------------------------------------------------------", New Font("Monotype", 12, FontStyle.Bold), Brushes.Black, New Point(30, 120))

        e.Graphics.DrawString(txtProductName.Text, New Font("Arial", 10, FontStyle.Regular), Brushes.Black, New Point(30, 160))
        e.Graphics.DrawString(txtCartons.Text, New Font("Arial", 10, FontStyle.Regular), Brushes.Black, New Point(400, 160))
        e.Graphics.DrawString("Rs:" + txtTotalAmount.Text, New Font("Arial", 10, FontStyle.Regular), Brushes.Black, New Point(700, 160))

        e.Graphics.DrawString("-----------------------------------------------------------------------------------------------------------------", New Font("Monotype", 12, FontStyle.Bold), Brushes.Black, New Point(30, 250))

        e.Graphics.DrawString("Total Amount:", New Font("Arial", 10, FontStyle.Regular), Brushes.Black, New Point(20, 300))
        e.Graphics.DrawString("Rs:" + txtTotalAmount.Text, New Font("Arial", 10, FontStyle.Regular), Brushes.Black, New Point(700, 300))
        e.Graphics.DrawString("----------------------------------------------------------------------------------------------------------------------", New Font("Monotype", 12, FontStyle.Bold), Brushes.Black, New Point(30, 500))


    End Sub

    Private Sub PrintDocumentButton_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles PrintDocumentButton.Click
